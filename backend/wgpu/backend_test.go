...
// TestWGPUBackendImplementsInterface verifies that WGPUBackend implements RenderBackend.
func TestWGPUBackendImplementsInterface(t *testing.T) {
	var _ backend.RenderBackend = (*WGPUBackend)(nil)
}

// TestWGPUBackendRegistration verifies that the backend is registered.
func TestWGPUBackendRegistration(t *testing.T) {
	if !backend.IsRegistered(backend.BackendWGPU) {
		t.Error("wgpu backend should be registered")
	}
}

// TestWGPUBackendGet verifies that the backend can be retrieved.
func TestWGPUBackendGet(t *testing.T) {
...
// TestWGPUBackendName verifies the backend name.
func TestWGPUBackendName(t *testing.T) {
	b := NewWGPUBackend()
	if b.Name() != "wgpu" {
...
// TestWGPUBackendInit tests initialization.
func TestWGPUBackendInit(t *testing.T) {
	b := NewWGPUBackend()
...
// TestWGPUBackendClose tests resource cleanup.
func TestWGPUBackendClose(t *testing.T) {
	b := NewWGPUBackend()
...
// TestWGPUBackendNewRenderer tests renderer creation.
func TestWGPUBackendNewRenderer(t *testing.T) {
	b := NewWGPUBackend()
...
// TestWGPUBackendNewRendererInvalidDimensions tests invalid dimension handling.
func TestWGPUBackendNewRendererInvalidDimensions(t *testing.T) {
	b := NewWGPUBackend()
...
// TestWGPUBackendRenderScene tests scene rendering.
func TestWGPUBackendRenderScene(t *testing.T) {
	b := NewWGPUBackend()
...
// TestWGPUBackendConcurrency tests concurrent access to the backend.
func TestWGPUBackendConcurrency(t *testing.T) {
	b := NewWGPUBackend()
...
// BenchmarkWGPUBackendInit benchmarks backend initialization.
func BenchmarkWGPUBackendInit(b *testing.B) {
	for i := 0; i < b.N; i++ {
		wb := NewWGPUBackend()
