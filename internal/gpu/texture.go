...
var (
	...
	ErrTextureDestroyed = errors.New("gpu: texture has been destroyed")
	...
	ErrInvalidTextureSize = errors.New("gpu: invalid texture size")

	// ErrDefaultViewCreationFailed is returned when lazy default view creation fails.
	ErrDefaultViewCreationFailed = errors.New("gpu: failed to create default view")
)
...
// gpu format. This is the most common use case for render targets and
// texture bindings.
//
